...
const finalPath = path.join(outputDir, "tabla_mercado_modelos_2026.xlsx");
const previewPath = path.join(outputDir, "preview_tabla_mercado_modelos_2026.png");
...
const sections = [
  ...
  {
    title: "Vehiculo de Pasajeros | bracket $25.000.000 a $50.000.000 CLP | 2026",
    total2026: 2814,
    rows: [
...
function writeSection(sheet, section, startRow) {
  ...
  const headers = ["Ranking", "Marca", "Modelo", "Precio bruto historico", "Demanda Anual 2026", "MS 2026"];
